...
async function fetchFiles() {
  ...
  files.forEach(file => {
    ...
    const timestamp = parseInt(file.split('-')[0]); // timestamp prefix
...
document.addEventListener('mouseleave', () => card.style.transform='rotateX(0) rotateY(0) scale(1)');
